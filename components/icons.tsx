...
export const SpinnerIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg aria-hidden="true" className={className || 'w-8 h-8 text-gray-200 animate-spin dark:text-zinc-600 fill-brand-primary'} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SharpnessIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
